...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "services.marketing.title": "AI-Powered Marketing",
    "services.marketing.desc": "Intelligent marketing automation that analyzes customer behavior, sends personalized campaigns, and optimizes timing for maximum engagement. Increase repeat business automatically.",
    ...
    "industries.cafes.title": "Clinics",
    "industries.cafes.desc": "AI voice assistant handles appointment scheduling, answers patient questions about services and availability, and sends automated appointment reminders. Reduce missed appointments and free up reception staff to focus on patient care.",
    "industries.restaurants.title": "Physiotherapists",
    "industries.restaurants.desc": "Smart booking system lets patients schedule sessions 24/7 via phone or chat. AI assistant answers common questions about treatments, pricing, and insurance. Automated follow-up reminders for ongoing treatment plans keep patients on track.",
    ...
    // Pricing
    "pricing.title1": "Custom",
    "pricing.title2": " Pricing",
    "pricing.subtitle": "Pricing is customized based on your business needs. Every solution is tailored to deliver maximum value.",
  ...
  sv: {
    ...
    "services.marketing.title": "AI-Driven Marknadsföring",
    "services.marketing.desc": "Intelligent marknadsföringsautomation som analyserar kundbeteende, skickar personliga kampanjer och optimerar timing för maximalt engagemang. Öka återkommande affärer automatiskt.",
    "services.social.title": "Social Media-Automation",
    ...
    "industries.cafes.title": "Kliniker",
    "industries.cafes.desc": "AI-röstassistent hanterar tidsbokning, svarar på patientfrågor om tjänster och tillgänglighet, och skickar automatiska bokningspåminnelser. Minska uteblivna besök och frigör receptionspersonal för patientvård.",
    "industries.restaurants.title": "Fysioterapeuter",
    "industries.restaurants.desc": "Smart bokningssystem låter patienter boka sessioner dygnet runt via telefon eller chatt. AI-assistent svarar på vanliga frågor om behandlingar, priser och försäkringar. Automatiska uppföljningspåminnelser för pågående behandlingsplaner.",
    ...
    // Pricing
    "pricing.title1": "Anpassade",
    "pricing.title2": " Priser",
    "pricing.subtitle": "Priserna anpassas efter ditt företags behov. Varje lösning skräddarsys för att ge maximalt värde.",
    "pricing.cta": "Få Ditt Anpassade Pris",
