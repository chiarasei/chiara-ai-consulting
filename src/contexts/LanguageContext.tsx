...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "industries.cafes.title": "Cafés",
    "industries.cafes.desc": "AI voice assistant takes phone orders during busy hours, chatbot answers menu questions and handles dietary restrictions. Automated order confirmations and loyalty rewards for regulars. Increase takeaway sales by 30-50%.",
  ...
  sv: {
    ...
    "industries.cafes.title": "Kaféer",
    "industries.cafes.desc": "AI-röstassistent tar emot telefonbeställningar under rusningstid, chatbot svarar på menyfrågor och hanterar kostrestriktioner. Automatiska orderbekräftelser och lojalitetsbelöningar för stamgäster.",
