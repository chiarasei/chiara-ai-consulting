...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "pricing.note": "Final pricing may vary depending on the number of pages, e-commerce requirements, and automation complexity.",
    "pricing.delivery": "Delivery time: 3–5 days",
    "pricing.starter.name": "Starter Business Website",
    "pricing.starter.price": "7,000 SEK",
    "pricing.starter.f1": "Building a new website from scratch OR redesigning an existing website",
    "pricing.starter.f2": "Modern professional design",
    "pricing.starter.f3": "Mobile-friendly and responsive layout",
    ...
    "pricing.starter.f7": "Fast loading performance",
    ...
    "pricing.growth.f1": "AI chatbot trained to answer common customer questions",
    "pricing.growth.f2": "Automated responses for website visitors",
    "pricing.growth.f3": "Booking or appointment calendar integration",
    "pricing.growth.f4": "Improved customer engagement",
    "pricing.growth.f5": "Mobile-optimized chatbot",
    "pricing.premium.name": "Advanced Automation Website",
    "pricing.premium.price": "14,000 SEK",
    "pricing.premium.includes": "Everything in Package 2 plus:",
    "pricing.premium.f1": "AI chatbot automation",
    "pricing.premium.f2": "Optional AI voice assistant for customer interactions",
    "pricing.premium.f3": "Advanced automation setup for business workflows",
    "pricing.premium.f4": "Booking system automation",
    "pricing.premium.f5": "E-commerce functionality if required (product listings, payment gateway, and checkout setup)",
    ...
    "pricing.maintenance.f4": "Support for chatbot and automation tools",
  ...
  sv: {
    ...
    "pricing.note": "Slutpris kan variera beroende på antal sidor, e-handelskrav och automationens komplexitet.",
    "pricing.delivery": "Leveranstid: 3–5 dagar",
    "pricing.starter.name": "Starter Företagshemsida",
    "pricing.starter.price": "7 000 SEK",
    "pricing.starter.f1": "Bygga en ny hemsida från grunden ELLER omdesigna en befintlig hemsida",
    "pricing.starter.f2": "Modern professionell design",
    "pricing.starter.f3": "Mobilvänlig och responsiv layout",
    ...
    "pricing.starter.f7": "Snabb laddningsprestanda",
    "pricing.growth.name": "Hemsida + AI Chattassistent",
    "pricing.growth.price": "10 000 SEK",
    "pricing.growth.includes": "Allt i Paket 1 plus:",
    "pricing.growth.f1": "AI-chatbot tränad att svara på vanliga kundfrågor",
    "pricing.growth.f2": "Automatiserade svar för webbplatsbesökare",
    "pricing.growth.f3": "Boknings- eller tidskalenderintegration",
    "pricing.growth.f4": "Förbättrat kundengagemang",
    "pricing.growth.f5": "Mobiloptimerad chatbot",
    "pricing.premium.name": "Avancerad Automationshemsida",
    "pricing.premium.price": "14 000 SEK",
    "pricing.premium.includes": "Allt i Paket 2 plus:",
    "pricing.premium.f1": "AI-chatbot automation",
    "pricing.premium.f2": "Valfri AI-röstassistent för kundinteraktioner",
    "pricing.premium.f3": "Avancerad automationsuppsättning för affärsflöden",
    "pricing.premium.f4": "Bokningssystemautomation",
    "pricing.premium.f5": "E-handelsfunktionalitet vid behov (produktlistor, betalningsgateway och kassauppsättning)",
    ...
    "pricing.maintenance.f4": "Support för chatbot och automationsverktyg",
